...
if($_POST) 
{
  if(is_numeric($_POST["l1"]) and is_numeric($_POST["w1"]) and is_numeric($_POST["l2"]) and is_numeric($_POST["w2"]) and is_numeric($_POST["distance"]))
  {
    $l1 = $_POST["l1"];
    $w1 = $_POST["w1"];
    $l2 = $_POST["l2"];
    ...
    $accepted_ratio = get_accepted_ratio($l1, $w1, $l2, $w2, $distance, $n_event);
    $rate = $l1*$w1*$norm_rate*$accepted_ratio;
    $accepted_ratio = 100*$accepted_ratio;

    echo "<h3>Parameters:</h3>";
    echo "Upper counter:<br>";
    echo "Length: <b>".$l1."cm</b> | | |  Width: <b>".$w1."cm</b><br>";
    echo "Lower counter:<br>";
    echo "Length: <b>".$l2."cm</b> | | |  Width: <b>".$w2."cm</b><br>";
